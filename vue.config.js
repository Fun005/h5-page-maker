...
let devServer = {
    proxy: { // 代理
        '/api/user/profile/info': { // 代理到 对缘
            target: 'http://testapi.yingtaorelian.com',//设置你调用的接口域名和端口号 别忘了加http
            ws: false,
            changeOrigin: true,
            pathRewrite: {}
        },
        '/activity/api/*': { // 代理到boss系统
            target: 'http://testboss.me.inke.cn',//设置你调用的接口域名和端口号 别忘了加http
            ws: false,
            changeOrigin: true,
            pathRewrite: {}
        },
        '/activity/activity/release': { // 代理到boss系统
        ...
        '/activity/*': { // 代理到 活动中台
            target: 'http://testactivity.busi.me.inke.cn',//设置你调用的接口域名和端口号 别忘了加http
            ws: false,
            changeOrigin: true,
            pathRewrite: {}
        },
