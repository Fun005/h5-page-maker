...
import root, { IS_DEV } from '@/config/apiRoots'
...
export default {
    ...
    computed: {
        previewUrl () {
            return IS_DEV ? `${protocol}//${root.h5host}/h5.html?${$utils.stringifyParams(this.globalVariable)}` : `${protocol}//${root.h5host}?${$utils.stringifyParams(this.globalVariable)}`
        }
    },
    data () {
        return {}
