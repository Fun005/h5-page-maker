...
/*
* 转译组件名称 QK to IK   QkMyPoints =>  ik-my-points
* */
export function translateNameQKToIK(componentName){
    return componentName.replace(/[A-Z]/g, (m) => '-' + m.toLowerCase()).replace(/-?qk-/g, 'ik-')
}
