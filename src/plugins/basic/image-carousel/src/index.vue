...
<template>
  <div class="qk-image-carsousel">
    <!--异步加载轮播图的情况;-->
    <Swiper class="image-carsousel-swiper" v-if="imageSrcList.length > 0" :key="imageSrcList.length"  :autoPlay='true' :showIndicator='true' :interval="interval" duration="500">
